<x-table-layout title="Edit Order Item">
    <div class="container mt-4">
        <div class="d-flex align-items-center mb-4">
            ...
            <h1 class="m-0">Edit Order Item #{{ $orderitem->id }}</h1>
        </div>
        ...
        <form action="{{ route('orderitems.update', $orderitem->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control @error('quantity') is-invalid @enderror" id="quantity" name="quantity" value="{{ old('quantity', $orderitem->quantity) }}">
                @error('quantity')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" step="0.01" class="form-control @error('price_at_purchase') is-invalid @enderror" id="price" name="price_at_purchase" value="{{ old('price_at_purchase', $orderitem->price_at_purchase) }}">
