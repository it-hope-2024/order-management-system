            ...
            @foreach ($orders as $order)
                <div class="bg-white shadow-lg rounded-lg p-6 mb-6 border border-gray-200">
                    ...
                    <p class="mt-4 text-lg font-bold text-gray-700 flex items-center">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-green-600 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-award"><path d="m15.477 12.89 1.515 8.526a.5.5 0 0 1-.81.47l-3.58-2.687a1 1 0 0 0-1.197 0l-3.586 2.686a.5.5 0 0 1-.81-.469l1.514-8.526"/><circle cx="12" cy="8" r="6"/></svg>
                        Total For Order # {{ $order->id }}: <span class="text-green-600 ml-1">{{ $order->total_price }}$</span>
                    </p>
                </div>
            @endforeach
        @endif
