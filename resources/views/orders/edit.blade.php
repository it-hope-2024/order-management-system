<x-table-layout title="Edit Order">
    <div class="container mt-4">
        ...
        <form action="{{ route('orders.update', $order->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" step="0.01"  class="form-control @error('total_price') is-invalid @enderror" id="total_price" name="total_price" value="{{ old('total_price', $order->total_price) }}">
                @error('total_price')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
